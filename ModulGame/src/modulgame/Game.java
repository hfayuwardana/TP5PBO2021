...
public class Game extends Canvas implements Runnable {
    ...
    public Game(String username, int lvl) {
        ...
        // memutar BGM
        playSound("/Joshua McLean - Mountain Trials.wav");
        ...
        // set nilai atribut username sesuai dengan username yang ada pada parameter (yg
        // berasal dari kelas Menu)
                ...
                for (int i = 0; i < handler.object.size(); i++) {
                    ...
                    if (handler.object.get(i).getId() == ID.Item) {
                        ...
                        if (checkCollision(playerObject, handler.object.get(i))
                                || (checkCollision(player2Object, handler.object.get(i)))) {
                            ...
                            if (countItem == 0) {
                                ...
                                handler.addObject(
                                        new Items(rand.nextInt(upperbound_x), rand.nextInt(upperbound_y), ID.Item));
                                countItem++;
                                handler.addObject(
                                        new Items(rand.nextInt(upperbound_x), rand.nextInt(upperbound_y), ID.Item));
                                countItem++;
                    ...
                    if (handler.object.get(i).getId() == ID.Enemy) {
                        ...
                        if (checkCollisionEnemy(playerObject, handler.object.get(i))
                                || (checkCollisionEnemy(player2Object, handler.object.get(i)))) {
    ...
    public static boolean checkCollision(GameObject player, GameObject item) {
        ...
        if ((playerRight > itemLeft) && (playerLeft < itemRight) && (itemBottom > playerTop)
    ...
    public static boolean checkCollisionEnemy(GameObject player, GameObject enemy) {
        ...
        // jika posisinya memakan
        if ((playerRight > enemyLeft) && (playerLeft < enemyRight) && (enemyBottom > playerTop)
    ...
    public void insert() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                int scr = rs.getInt(2);
                // jika username yg ada di database SAMA dgn username yg baru dimasukkan user
                // melalui input
                if (this.username.equals(uname)) {
                    // jika total score yg baru diperoleh username dalam game lebih besar dri score
                    // username tsb yg pernah ada di database
                    ...
                    // jika total score yg baru diperoleh username dalam game kurang dari atau sama
                    // dgn score username tsb yg pernah ada di database
                    else {
